...
## Project Structure
    ...
    ├── webapplicationtest__26008  # Django project configurations
...
1. Clone this repo and `cd webapplicationtest__26008`
...
2. Clone this repo and `cd webapplicationtest__26008`
